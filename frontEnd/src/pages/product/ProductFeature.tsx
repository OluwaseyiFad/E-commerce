const features = [
  ...
  {
    name: "Includes",
    description: "Phone, USB-C to Lightning cable, documentation",
  },
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-4 text-gray-500">
            The iPhone 14 Pro Max features a 6.7-inch Super Retina XDR display,
            powered by the fast A16 Bionic chip. With 256GB storage, a pro-level
            triple camera, and all-day battery life, it’s built for performance
            and elegance in sleek Space Black.
          </p>
